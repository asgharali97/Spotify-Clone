...
const SingleSongCard = ({ info, playSound }) => {
  ...
  return (
    <>
      <div
        className="flex p-2 hover:bg-gray-400 hover:bg-opacity-20 rounded-md "
        onClick={() => {
          setCurrentSong(info)
        }}
      >
        <div
          className="w-41 h-41 bg-cover bg-center"
          style={{ backgroundImage: `url(${info.thumbnail})` }}
        ></div>
        <div className="flex w-full">
          <div className="text-white flex justify-center flex-col pl-4">
