...
const Login = () => {
  ...
  const loginSubmit =async ()=>{
    ...
    const response = await UnPostRequest("/api/auth/login", data);
  ...
  return (
    ...
    <div className="p-4 w-full h-65 items-center flex bg-gray-20">
        ...
        <div className="w-1/3 py-10 flex items-center  flex-col">
          <div className="font-bold text-2xl mb-10">To continue, login to Spotify</div>
          <InputText 
            label={"Email Address"}
          ...
          <div className="w-full flex items-center justify-center my-8">
            <button className="bg-green-400 w-10 font-semibold p-3 px-10 rounded-full"  onClick={(e) => {
                e.preventDefault(e);
                loginSubmit();
              }}>
              LOG IN
